...
class PathPlanner(object):
    ...
    def set_goal_tolerance(self, value):
        # print('Current constraint is : {}'.format(self._group.get_goal_tolerance()))
        # # joint = float(raw_input("Tolerence value for joint: "))
        # # position = float(raw_input("Tolerence value for position: "))
        # # orientation = float(raw_input("Tolerence value for orientation: "))
        # # value = [joint, position, orientation]

        # value = float(raw_input("Tolerence value: "))

        self._group.set_goal_tolerance(value)	
